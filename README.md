...
Основная цель проекта — проект создан как учебная демонстрация современного backend-подхода к реализации серверных сессий с хранением session state в Redis.
